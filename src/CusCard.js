    ...
    <Card sx={{ maxWidth: 345 }} style={{ marginTop: "50px" }}>
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          ...
          <Typography sx={{ marginBottom: 2 }}>
            Add pimentón, bay leaves, garlic, tomatoes, onion, salt and pepper.
            Cook until thickened. Add saffron broth and chicken broth; bring to
            a boil.
          </Typography>
          <Typography>
            Add rice, peas, and mussels. Let cook until mussels open. Serve hot.
          </Typography>
        </CardContent>
      </Collapse>
    </Card>
